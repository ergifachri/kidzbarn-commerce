                ...
                <div className="main-navbar">
                    <div id="mainnav" >
                        ...
                        <ul className="nav-menu" style={this.state.navClose}>
                            ...
                            <li >
                                <Link to={`${process.env.PUBLIC_URL}/kids`} className="nav-link" >
                                    {translate('home')}
                                        ...
                                        <div className="row" >
                                            <div className="col mega-box" >
                                                <div className="link-section">
                                                    ...
                                                    <div className="menu-content">
                                                        <ul>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Wtp</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Connetix</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Grimms</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Grapat</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col mega-box">
                                                <div className="link-section">
                                                    ...
                                                    <div className="menu-content">
                                                        <ul>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Clicque</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Flockmen</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Tegu</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Avdar</Link></li>
                            ...
                            <li>
                                <Link to={`${process.env.PUBLIC_URL}/pages/about-us`} className="nav-link"/*  onClick={(e) => this.handleSubmenu(e)} */>
                                    {translate('about_us')}
                                </Link>
                                {/* <ul className="nav-submenu">
...
export default withTranslate(NavBarBak);