                                ...
                                <div className="col-lg-6">
                                    <div className="subscribe">
                                        <div>
                                            ...
                                            <p>Never Miss Anything From Kidsbarn By Signing Up To Our Newsletter. </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                        ...
                        <div className="row footer-theme partition-f">
                            <div className="col-lg-4 col-md-6">
                                ...
                                <div className="footer-contant">
                                   ...
                                   */}  </div>
                                    <p>Here, you can find numerous high quality children books as well as curated educational toys.   </p>
                                ...
                                <div className="sub-title">
                                    ...
                                    <div className="footer-contant">
                                        <ul className="contact-list">
                                            <li><i className="fa fa-map-marker"></i>Kidzbarn Store,
                                                Indonesia
                                            </li>
